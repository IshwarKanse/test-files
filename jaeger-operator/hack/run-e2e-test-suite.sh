...
KUBECONFIG=$KUBECONFIG $KUTTL test $KUTTL_OPTIONS --report xml
exit_code=$?
...
junitcli --suite-name $test_suite_name --report --output $reports_dir/$test_suite_name.xml ./artifacts/kuttl-report.xml
